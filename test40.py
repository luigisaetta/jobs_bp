...
MODEL_DISPLAY_NAME = "logreg-model-new4-test-job"
MODEL_DESC = "A new logreg model new40 for testing jobs"
...
# check if it is always the same
...
try:
    ...
    # added for test40: copy score.py in PATH_ARTEFACT
    print('Copy score.py')
    copy(PATH_DECOMPRESSED + "/score.py", PATH_ARTEFACT)
